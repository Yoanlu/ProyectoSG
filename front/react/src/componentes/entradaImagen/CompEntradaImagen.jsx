...
import estilos from "./CompEntradaImagen.module.css";
 ...
 */
class CompEntradaImagen extends React.PureComponent {
    static propTypes = {
        /**
            ...
            <ProveedorModoconsulta.Consumer>
                {modoConsulta => (
                    <div className={estilos.contenedorEntradaImagen}>
                        ...
                        <img onClick={this.funcionAbrirImagen} src={this.props.valor} alt={this.props.alternativo} className={estilos.imagen} />

                        <div className={"row " + estilos.contenedorBotonesEntradaImagen}>
                            <EleBoton
                            ...
                            {mostrarBorrar && (
                                <EleBoton
                                    claseCss={estilos.boton + " " + estilos.botonDerecho}
                                    desactivado={this.props.desactivado || modoConsulta}
                                    primario
                                    icono="delete"
                                    tipo="button"
...
export default CompEntradaImagen;
